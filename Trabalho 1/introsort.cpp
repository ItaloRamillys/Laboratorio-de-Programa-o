...
class Intro{
    ...
    void IntrosortUtil(int inicio, int fim, int limite, char *lado) {
        ...
        */
        ...
        // int particao = particionar(inicio, fim);

        // IntrosortUtil(inicio, particao - 1, limite - 1, "Esquerda");
        // IntrosortUtil(particao + 1, fim, limite - 1, "Direita");
    ...
    void Introsort(int inicio, int fim) {
        ...
        IntrosortUtil(inicio, fim, limite, "Primeiro");
